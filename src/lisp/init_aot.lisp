...
;;; --- 条件システム: signal-condition中核 (M12 Phase 8, #27) ---
;;;
...
;;; (spec 7080-7081行等、各データ表の「An error shall be signaled if X is not a
;;; condition of class <X> (error-id. domain-error)」という要求に対応)。
